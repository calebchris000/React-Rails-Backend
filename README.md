...
> Hello Rails BACKEND is a part of an application involved in consuming the api for the backend of the rails server.
...
> You can get the link to the react app below:

[React-Rails-Frontend](https://github.com/calebchris000/React-Rails-Frontend)
### Key Features <a name="key-features"></a>

- Greetings can be generated randomly
